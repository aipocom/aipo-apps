...
public class HomeControllerTest extends ControllerTestCase {
  ...
  public void run() throws Exception {
    ...
    tester.start("/api/statuses/home");
    ...
    assertThat(output, containsString("This is body4."));
    assertThat(output, containsString("This is body5."));
    assertThat(output, containsString("This is body6."));
    assertThat(output, containsString("This is body7."));
    assertThat(output, containsString("This is body8."));
    assertThat(output, containsString("This is body9."));
    assertThat(output, containsString("This is body10."));
    assertThat(output, containsString("This is body11."));
    assertThat(output, containsString("This is body12."));
    assertThat(output, containsString("This is body13."));
    assertThat(output, containsString("This is body14."));
    assertThat(output, containsString("This is body15."));
    assertThat(output, containsString("This is body16."));
    assertThat(output, containsString("This is body17."));
    assertThat(output, containsString("This is body18."));
    assertThat(output, containsString("This is body19."));
    assertThat(output, containsString("This is body20."));
    assertThat(output, containsString("This is body21."));
    assertThat(output, containsString("This is body22."));
    assertThat(output, containsString("This is body23."));
