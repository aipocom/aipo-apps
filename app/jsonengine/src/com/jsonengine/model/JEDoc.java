...
public class JEDoc implements Serializable {
    ...
    /**
     * A registered property name for org of each JSON document.
     */
    public static final String PROP_NAME_ORG = "org";
    
    /**
     * A registered property name for user of each JSON document.
     */
    ...
    public void update(CRUDRequest cReq) {
        ...
        getDocValues().put(PROP_NAME_ORG, getOrg());
        getDocValues().put(PROP_NAME_USER, getUser());
